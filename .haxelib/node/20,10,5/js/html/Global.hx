...
@:native("") extern class Global {
	@:overload(function(input:ts.AnyOf3<String, js.html.URL, js.html.Request>, ?init:js.html.RequestInit):js.lib.Promise<js.html.Response> { })
	static function fetch(input:js.html.RequestInfo, ?init:js.html.RequestInit):js.lib.Promise<js.html.Response>;
	/**
