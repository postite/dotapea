...
@:jsRequire("crypto", "Hmac") extern class Hmac extends node.stream.Transform {
	...
	**/
	@:overload(function(data:String, inputEncoding:global.nodejs.BufferEncoding):Hmac { })
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Hmac { })
	@:overload(function(event:String, listener:() -> Void):Hmac { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Hmac { })
	@:overload(function(event:String, listener:() -> Void):Hmac { })
	@:overload(function(event:String, listener:() -> Void):Hmac { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Hmac { })
