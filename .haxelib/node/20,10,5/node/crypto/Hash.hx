...
@:jsRequire("crypto", "Hash") extern class Hash extends node.stream.Transform {
	...
	**/
	@:overload(function(data:String, inputEncoding:global.nodejs.BufferEncoding):Hash { })
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Hash { })
	@:overload(function(event:String, listener:() -> Void):Hash { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Hash { })
	@:overload(function(event:String, listener:() -> Void):Hash { })
	@:overload(function(event:String, listener:() -> Void):Hash { })
	@:overload(function(event:String, listener:(src:node.stream.Readable) -> Void):Hash { })
