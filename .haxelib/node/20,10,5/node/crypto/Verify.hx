...
@:jsRequire("crypto", "Verify") extern class Verify extends node.stream.Writable {
	...
	**/
	@:overload(function(data:String, inputEncoding:global.nodejs.BufferEncoding):Verify { })
	...
	**/
	@:overload(function(object:ts.AnyOf6<String, node.buffer.Buffer, KeyObject, VerifyKeyObjectInput, VerifyPublicKeyInput, VerifyJsonWebKeyInput>, signature:String, ?signature_format:BinaryToTextEncoding):Bool { })
	function verify(object:ts.AnyOf6<String, node.buffer.Buffer, KeyObject, VerifyKeyObjectInput, VerifyPublicKeyInput, VerifyJsonWebKeyInput>, signature:global.nodejs.ArrayBufferView):Bool;
	/**
