...
@:jsRequire("http2", "Http2ServerResponse") extern class Http2ServerResponse extends node.stream.Writable {
	...
	**/
	...
	@:overload(function(data:ts.AnyOf2<String, js.lib.Uint8Array>, encoding:global.nodejs.BufferEncoding, ?callback:() -> Void):Http2ServerResponse { })
	...
	**/
	@:overload(function(chunk:ts.AnyOf2<String, js.lib.Uint8Array>, encoding:global.nodejs.BufferEncoding, ?callback:(err:js.lib.Error) -> Void):Bool { })
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):Http2ServerResponse;
	/**
