...
typedef Http2Session = {
	...
	**/
	...
	@:overload(function(event:String, listener:ts.AnyOf2<(errorCode:Float, lastStreamID:Float) -> Void, (errorCode:Float, lastStreamID:Float, opaqueData:node.buffer.Buffer) -> Void>):Http2Session { })
