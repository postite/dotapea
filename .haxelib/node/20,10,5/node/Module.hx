	...
	**/
	...
	static var Module : {
		...
		**/
		...
		var Module : Dynamic;
		@:overload(function<Data>(specifier:ts.AnyOf2<String, node.url.URL>, ?options:Module<Data>):Void { })
		function register<Data>(specifier:ts.AnyOf2<String, node.url.URL>, ?parentURL:ts.AnyOf2<String, node.url.URL>, ?options:Module<Data>):Void;
	};
	@:overload(function<Data>(specifier:ts.AnyOf2<String, node.url.URL>, ?options:Module<Data>):Void { })
	static function register<Data>(specifier:ts.AnyOf2<String, node.url.URL>, ?parentURL:ts.AnyOf2<String, node.url.URL>, ?options:Module<Data>):Void;
	/**
		The `module.syncBuiltinESMExports()` method updates all the live bindings for
		builtin `ES Modules` to match the properties of the `CommonJS` exports. It
		does not add or remove exported names from the `ES Modules`.
