...
typedef Unzip = {
	...
	**/
	function map(fn:ts.AnyOf2<(data:Dynamic) -> Dynamic, (data:Dynamic, options:{ /** allows destroying the stream if the signal is aborted. **/ @:optional var signal : js.html.AbortSignal; }) -> Dynamic>, ?options:Unzip):node.stream.Readable;
	/**
		This method allows filtering the stream. For each chunk in the stream the *fn* function will be called
		and if it returns a truthy value, the chunk will be passed to the result stream.
		If the *fn* function returns a promise - that promise will be `await`ed.
	**/
	function filter(fn:ts.AnyOf2<(data:Dynamic) -> ts.AnyOf2<Bool, js.lib.Promise<Bool>>, (data:Dynamic, options:{ /** allows destroying the stream if the signal is aborted. **/ @:optional var signal : js.html.AbortSignal; }) -> ts.AnyOf2<Bool, js.lib.Promise<Bool>>>, ?options:Unzip):node.stream.Readable;
	/**
	...
	**/
	function some(fn:ts.AnyOf2<(data:Dynamic) -> ts.AnyOf2<Bool, js.lib.Promise<Bool>>, (data:Dynamic, options:{ /** allows destroying the stream if the signal is aborted. **/ @:optional var signal : js.html.AbortSignal; }) -> ts.AnyOf2<Bool, js.lib.Promise<Bool>>>, ?options:Unzip):js.lib.Promise<Bool>;
	/**
	...
	**/
	@:overload(function(fn:ts.AnyOf2<(data:Dynamic) -> ts.AnyOf2<Bool, js.lib.Promise<Bool>>, (data:Dynamic, options:{ /** allows destroying the stream if the signal is aborted. **/ @:optional var signal : js.html.AbortSignal; }) -> ts.AnyOf2<Bool, js.lib.Promise<Bool>>>, ?options:Unzip):js.lib.Promise<Dynamic> { })
	function find<T>(fn:ts.AnyOf2<(data:Dynamic) -> Bool, (data:Dynamic, options:{ /** allows destroying the stream if the signal is aborted. **/ @:optional var signal : js.html.AbortSignal; }) -> Bool>, ?options:Unzip):js.lib.Promise<Null<T>>;
	/**
	...
	**/
	function every(fn:ts.AnyOf2<(data:Dynamic) -> ts.AnyOf2<Bool, js.lib.Promise<Bool>>, (data:Dynamic, options:{ /** allows destroying the stream if the signal is aborted. **/ @:optional var signal : js.html.AbortSignal; }) -> ts.AnyOf2<Bool, js.lib.Promise<Bool>>>, ?options:Unzip):js.lib.Promise<Bool>;
	/**
	...
	**/
	function flatMap(fn:ts.AnyOf2<(data:Dynamic) -> Dynamic, (data:Dynamic, options:{ /** allows destroying the stream if the signal is aborted. **/ @:optional var signal : js.html.AbortSignal; }) -> Dynamic>, ?options:Unzip):node.stream.Readable;
	/**
