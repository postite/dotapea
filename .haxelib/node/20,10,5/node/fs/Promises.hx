...
@:jsRequire("fs/promises") @valueModuleOnly extern class Promises {
	...
	**/
	static function appendFile(path:ts.AnyOf4<String, node.fs.promises.FileHandle, node.buffer.Buffer, node.url.URL>, data:ts.AnyOf2<String, js.lib.Uint8Array>, ?options:ts.AnyOf2<String, ObjectEncodingOptions & node.fs.promises.FlagAndOpenMode & { @:optional var flush : Bool; }>):js.lib.Promise<ts.Undefined>;
	/**
