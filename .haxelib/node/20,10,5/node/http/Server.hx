...
@:jsRequire("http", "Server") extern class Server<Request, Response> extends node.net.Server {
	...
	**/
	...
	@:overload(function(event:String, listener:(req:js.lib.InstanceType<Request>, socket:node.stream.Duplex) -> Void):Server<Request, Response> { })
	@:overload(function(event:String, listener:RequestListener<Request, Response>):Server<Request, Response> { })
	@:overload(function(event:String, listener:(req:js.lib.InstanceType<Request>, socket:node.stream.Duplex, head:node.buffer.Buffer) -> Void):Server<Request, Response> { })
	...
	**/
	...
	@:overload(function(event:String, req:js.lib.InstanceType<Request>, socket:node.stream.Duplex):Bool { })
	@:overload(function(event:String, req:js.lib.InstanceType<Request>, res:Dynamic):Bool { })
	@:overload(function(event:String, req:js.lib.InstanceType<Request>, socket:node.stream.Duplex, head:node.buffer.Buffer):Bool { })
