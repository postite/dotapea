...
@:jsRequire("fs") @valueModuleOnly extern class Fs {
	...
	**/
	static function writeFileSync(file:node.fs.PathOrFileDescriptor, data:node.crypto.BinaryLike, ?options:ts.AnyOf2<String, node.fs.ObjectEncodingOptions & node.events.eventemitter.Abortable & { @:optional var mode : ts.AnyOf2<String, Float>; @:optional var flag : String; @:optional var flush : Bool; }>):Void;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	static function appendFileSync(path:node.fs.PathOrFileDescriptor, data:ts.AnyOf2<String, js.lib.Uint8Array>, ?options:ts.AnyOf2<String, node.fs.ObjectEncodingOptions & node.events.eventemitter.Abortable & { @:optional var mode : ts.AnyOf2<String, Float>; @:optional var flag : String; @:optional var flush : Bool; }>):Void;
	/**
