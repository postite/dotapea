...
/**
	...
	* `crypto streams`
**/
@:jsRequire("stream", "Duplex") extern class Duplex extends Duplex {
	...
	**/
	static function from(src:ts.AnyOf9<String, Dynamic, node.buffer.Blob, js.lib.ArrayBuffer, Stream, js.lib.Promise<Dynamic>, Iterable<Dynamic>, js.lib.AsyncIterable<Dynamic>, js.lib.AsyncGeneratorFunction>):Duplex;
	/**
