@:jsRequire("undici-types") @valueModuleOnly extern class UndiciTypes {
	...
	**/
	static function pipeline(url:ts.AnyOf3<String, node.url.URL, node.url.UrlObject>, options:Dynamic, handler:undici_types.dispatcher.PipelineHandler):node.stream.Duplex;
	/**
	...
	**/
	...
	static function getSetCookies(headers:js.html.Headers):Array<undici_types.Cookie>;
	static function setCookie(headers:js.html.Headers, cookie:undici_types.Cookie):Void;
	...
	/**
		...
		couldn't be parsed.
	**/
	static function parseMIMEType(input:String):ts.AnyOf2<String, undici_types.MIMEType>;
	/**
