package undici_types.readable;

@:jsRequire("undici-types/readable", "default") extern class BodyReadable extends node.stream.Readable {
	function new(?resume:(size:Float) -> Null<ts.Undefined>, ?abort:() -> Null<ts.Undefined>, ?contentType:String);
	/**
	...
	**/
	...
	function compose<T>(stream:ts.AnyOf4<ComposeFnParam, Iterable<T>, js.lib.AsyncIterable<T>, T>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):BodyReadable;
	/**
