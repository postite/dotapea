...
@:jsRequire("undici-types/mock-interceptor", "MockInterceptor") extern class MockInterceptor {
	...
	**/
	@:overload(function<TData>(statusCode:Float, ?data:ts.AnyOf4<String, node.buffer.Buffer, undici_types.mock_interceptor.mockinterceptor.MockResponseDataHandler<TData>, TData>, ?responseOptions:undici_types.mock_interceptor.mockinterceptor.MockResponseOptions):MockScope<TData> { })
	function reply<TData>(replyOptionsCallback:undici_types.mock_interceptor.mockinterceptor.MockReplyOptionsCallback<TData>):MockScope<TData>;
	/**
