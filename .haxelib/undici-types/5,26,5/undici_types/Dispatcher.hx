...
**/
@:jsRequire("undici-types", "Dispatcher") extern class Dispatcher extends node.Events {
	/**
	...
	**/
	function pipeline(options:undici_types.dispatcher.PipelineOptions, handler:undici_types.dispatcher.PipelineHandler):node.stream.Duplex;
	/**
